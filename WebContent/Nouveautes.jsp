...
<h5>Accueil > Nouveautes</h5>
<h2>Nouveautes</h2>
<%
	List<Livre> livres = GestionClient.chercherLivreNouveautes();
	request.getSession().setAttribute("livre", livres);
	for (int i=0; i < livres.size(); i++ ){%>
<div>
<table class="li" width="100%">			
	<tr>
  		<td class="li">
        <td class="li"><img src="img/<%=livres.get(i).getImage() %>" /></td>
  		...
  		<td class="li">           
     		<table>
     			<tr>
     				<td class="hh"><a href="./Paniernouv?nom=<%=livres.get(i).getId() %>"><button id="registerNew" >Ajouter au Panier</button></a></td>
     			</tr>
     		</table>      
   		</td>
<%}%>
