...
<h5>Accueil > Livres FR</h5>
<h2>LIVRES FRANCAIS</h2>
<%
	String categorie = "francais";
...
<table class="li" width="80%">			
	<tr>
  		<td class="li">
            ...
            <table>
     			<tr>
     				<td class="hh"><a href="./Panierfr?nom=<%=livres.get(i).getId() %>"><button id="registerNew" >Ajouter au Panier</button></a></td>
     			</tr>
    		 </table>    
   		</td>
 <%}%>
